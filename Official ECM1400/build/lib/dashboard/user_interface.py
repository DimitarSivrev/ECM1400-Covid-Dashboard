...
def index():
    ...
    if text_field:
        ...
        if covid_data:
            ...
            if repeat:
                schedule_covid_updates(future_time,
                (text_field+" (repeating update) (covid)"),
        ...
        if news_update:
            ...
            if repeat:
                schedule_news_updates(future_time,
                (text_field+" (repeating update) (news)"),
                update_type="repeating")
    ...
    local_7day_infections = local_cases_by_publish_date[0],
    nation_location = config_country,
    national_7day_infections = national_cases_by_publish_date[0],
    hospital_cases = ("Hospital Cases in " + config_country + " : " + str(hospital_cases[0])),
    deaths_total = ("Deaths in last 28 days in " 
    + config_country + ": " + str(cumulative_cases[0])),
